  ...
  return knex('questions').truncate()
    .then(function () {
      return knex('questions').insert([
        ...
        {question: 'What is a variable?', answer: 'Variables store data in memory. Using a classroom example, a variable is like a storage container while the variable name is the label on the container and the variable value is the item in the container'},
        ...
        {question: 'Why convert a NodeList into an Array?', answer: 'In order to use Array methods to manipulate the NodeList data'},
