...
function DonatePage(props) {
  return (
    <div className="home-container">
      ...
      <p className="tagline">
        Donations like yours help maintain the site running so future <a href="https://lambdaschool.com/">Lambda School</a> students can use it to prepare for interviews
      </p>
